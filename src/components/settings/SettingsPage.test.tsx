...
describe('SettingsPage theme presets', () => {
  beforeEach(() => {
    ...
    mockedUseSettingsSlice.mockReturnValue({
      ...
      exportMerchantRules: vi.fn().mockResolvedValue({
      ...
      importMerchantRules: vi.fn().mockResolvedValue({ imported: 0, rejected: 0 }),
      ...
      changePassword: vi.fn().mockResolvedValue({ syncError: null }),
      lockDatabase: vi.fn().mockResolvedValue({ locked: true, syncError: null }),
      syncNow: vi.fn().mockResolvedValue(undefined),
      setAutoSyncEnabled: vi.fn(),
      setSyncIntervalMinutes: vi.fn(),
      reconnectCloudSource: vi.fn().mockResolvedValue(undefined),
      resolveCloudConflict: vi.fn().mockResolvedValue(undefined),
