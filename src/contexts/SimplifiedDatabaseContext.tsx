...
export const DatabaseProvider: React.FC<DatabaseProviderProps> = ({
  ...
  useEffect(() => {
    ...
    const initializeAndCheck = async () => {
      try {
        appLogger.info('Initializing database service...');
        ...
        const hasExisting = await service.checkForExistingDatabase();
        if (hasExisting) {
          appLogger.info('Found existing database, opening...');
          await service.openExistingDatabase();
          await loadAllData(service);
          setInitializationState('initialized');
        } else {
          appLogger.info('No existing database found');
  ...
  const createOrOpenDatabase = async (isNew: boolean) => {
    ...
    try {
      ...
      appLogger.error('Failed to create/open database:', err);
  ...
  const loadDatabaseFromFile = async (file: File) => {
    ...
    try {
      ...
      appLogger.error('Failed to load database from file:', err);
  ...
  const exportDatabase = async (): Promise<Uint8Array | null> => {
    ...
    try {
      ...
      appLogger.error('Failed to export database:', err);
  ...
  const refreshTransactions = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh transactions:', err);
    }
  };
  ...
  const refreshCategories = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh categories:', err);
    }
  };
  ...
  const refreshCompanies = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh companies:', err);
    }
  };
  ...
  const refreshAccounts = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh accounts:', err);
    }
  };
  ...
  const refreshBudgets = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh budgets:', err);
    }
  };
  ...
  const refreshProjects = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh projects:', err);
    }
  };
  ...
  const refreshAccountAliases = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh account aliases:', err);
    }
  };
  ...
  const refreshAll = async () => {
    ...
    try {
      ...
      appLogger.error('Failed to refresh all data:', err);
    }
  };
  ...
  const addTransaction = async (transaction: Omit<Transaction, "id" | "created_at" | "updated_at">) => {
    ...
    try {
      ...
      appLogger.error('Failed to add transaction:', err);
      throw err;
    }
  };
  ...
  const addCategory = async (category: Omit<Category, "id" | "created_at" | "updated_at">): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to add category:', err);
      throw err;
    }
  };
  ...
  const addCompany = async (name: string): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to add company:', err);
      throw err;
    }
  };
  ...
  const findOrCreateCompany = async (name: string): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to find or create company:', err);
      throw err;
    }
  };
  ...
  const addAccount = async (account: Omit<Account, "id" | "created_at" | "updated_at">): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to add account:', err);
      throw err;
    }
  };
  ...
  const deleteAccount = async (id: string) => {
    ...
    try {
      ...
      appLogger.error('Failed to delete account:', err);
      throw err;
    }
  };
  ...
  const addBudget = async (budget: Omit<Budget, "id" | "created_at" | "updated_at">): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to add budget:', err);
      throw err;
    }
  };
  ...
  const addProject = async (project: Omit<Project, "id" | "created_at" | "updated_at">): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to add project:', err);
      throw err;
    }
  };
  ...
  const updateProject = async (id: string, updates: Partial<Omit<Project, "id" | "created_at" | "updated_at">>) => {
    ...
    try {
      ...
      appLogger.error('Failed to update project:', err);
      throw err;
    }
  };
  ...
  const deleteProject = async (id: string) => {
    ...
    try {
      ...
      appLogger.error('Failed to delete project:', err);
      throw err;
    }
  };
  ...
  const getProjectById = async (id: string): Promise<Project | null> => {
    ...
    try {
      ...
      appLogger.error('Failed to get project by id:', err);
      return null;
    }
  };
  ...
  const getTransactionsByProject = async (projectId: string): Promise<Transaction[]> => {
    ...
    try {
      ...
      appLogger.error('Failed to get transactions by project:', err);
      return [];
    }
  };
  ...
  const getProjectCosts = async (projectId: string): Promise<{ estimated: number; actual: number; transactions_total: number }> => {
    ...
    try {
      ...
      appLogger.error('Failed to get project costs:', err);
      return { estimated: 0, actual: 0, transactions_total: 0 };
    }
  };
  ...
  const getAccountAliases = async (): Promise<AccountAlias[]> => {
    ...
    try {
      ...
      appLogger.error('Failed to get account aliases:', err);
      return [];
    }
  };
  ...
  const getAccountAliasesByAccountId = async (accountId: string): Promise<AccountAlias[]> => {
    ...
    try {
      ...
      appLogger.error('Failed to get account aliases by account id:', err);
      return [];
    }
  };
  ...
  const findAccountAliasesByLastFour = async (lastFour: string): Promise<AccountAlias[]> => {
    ...
    try {
      ...
      appLogger.error('Failed to find account aliases by last four:', err);
      return [];
    }
  };
  ...
  const addAccountAlias = async (alias: Omit<AccountAlias, "id" | "created_at" | "updated_at">): Promise<string> => {
    ...
    try {
      ...
      appLogger.error('Failed to add account alias:', err);
      throw err;
    }
  };
