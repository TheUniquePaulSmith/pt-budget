...
export function useSettingsSlice() {
  ...
  return {
    ...
    changePassword: lifecycle.changePassword,
    lockDatabase: lifecycle.lockDatabase,
    unlockDatabase: lifecycle.unlockDatabase,
    syncNow: lifecycle.syncNow,
    setAutoSyncEnabled: lifecycle.setAutoSyncEnabled,
    setSyncIntervalMinutes: lifecycle.setSyncIntervalMinutes,
    reconnectCloudSource: lifecycle.reconnectCloudSource,
    resolveCloudConflict: lifecycle.resolveCloudConflict,
